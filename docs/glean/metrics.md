...
| --- | --- | --- | --- | --- | --- |
| legacy.ids.client_id |[uuid](https://mozilla.github.io/glean/book/user/metrics/uuid.html) |The client id from legacy telemetry.  |[1](https://github.com/mozilla-lockwise/lockwise-android/pull/1196)||never |
